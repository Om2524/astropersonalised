...
from src.engines.base import BaseEvidence
from src.engines.vedic import VedicEngine, VedicEvidence
from src.engines.kp import KPEngine, KPEvidence
from src.engines.western import WesternEngine, WesternEvidence


class CompareEvidence(BaseModel):
    """Aggregated evidence from all three engines with cross-method analysis."""
...
class CompareEngine:
    """Runs Vedic, KP, and Western engines, then synthesises cross-method insights."""
    ...
    def extract_evidence(
        ...
        """Extract evidence from all three systems and identify convergences."""
