...
from src.core.models.chart import CanonicalChart, PlanetPosition, HouseCusp
...
NAKSHATRA_SPAN = 13 + 20 / 60  # 13 deg 20' = 13.33333... deg
...
class KPEvidence(BaseEvidence):
    """Structured evidence produced by the KP interpretation engine."""
...
class KPEngine(BaseEngine):
    ...
    def extract_evidence(
        ...
        """Extract KP evidence for a given domain and query."""
        ...
        relevant_aspects: list[str] = []  # KP doesn't primarily use aspects
