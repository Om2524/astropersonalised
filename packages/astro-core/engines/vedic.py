...
from ..models.chart import CanonicalChart, PlanetPosition
...
# In traditional Vedic astrology these are derived from permanent
# friendship tables; here we keep a simplified lookup.
FRIENDLY_SIGNS = {
...
def _detect_viparita_raja(
    ...
    """Lords of 6, 8, 12 placed in each other's houses."""
